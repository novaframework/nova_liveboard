...
mount(_Arg, Req) ->
    ...
    Sorted = lists:sort(fun(A, B) -> maps:get(memory_bytes, A) >= maps:get(memory_bytes, B) end, Tables),
    ...
    <div id="{arizona_template:get_binding(id, Bindings)}">
        ...
        <div class="card">
            <table>
                ...
                <tbody>
                    {arizona_template:render_list(fun render_table_row/1, Tables)}
                </tbody>
            </table>
        </div>
    </div>
